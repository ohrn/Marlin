...
#include "Configuration_ZYYX_Pro.h"
...
#define STRING_CONFIG_H_AUTHOR "(JFO)" // Who made the changes.
...
#include "Configuration_Robin_Nano.h"
#elif MOTHERBOARD == BOARD_MKS_ROBIN_NANO_V2
#include "Configuration_Robin_Nano_v2.h"
#elif MOTHERBOARD == BOARD_MKS_SGEN_L
#include "Configuration_SGEN_L_v1.h"
#elif MOTHERBOARD == BOARD_MKS_SGEN_L_V2
#include "Configuration_SGEN_L_v2.h"
#else
#error "Unknown board"
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  6.1
    #define DEFAULT_Ki  1.8
    #define DEFAULT_Kd  7.8
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 850, 850, 50, 5000 }
